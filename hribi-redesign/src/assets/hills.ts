...
export const hills: Hill[] = [
    ...
    createHillData({ name: "Triglav (Peak)", lat: 46.3768, lon: 13.8378 }, 0, 'Julian Alps'),
    ...
    createHillData({ name: "Vogel (Ski Centre)", lat: 46.2625, lon: 13.8055 }, 5, 'Julian Alps'),
    ...
    createHillData({ name: "Osojnica (Bled)", lat: 46.3650, lon: 14.0750 }, 15, 'Julian Alps'),
    createHillData({ name: "Straža (Bled)", lat: 46.3680, lon: 14.1000 }, 16, 'Julian Alps'),
    createHillData({ name: "Vitranec (Kranjska Gora)", lat: 46.4900, lon: 13.7900 }, 17, 'Julian Alps'),
    createHillData({ name: "Vršič pass", lat: 46.4020, lon: 13.7590 }, 18, 'Julian Alps'),
    createHillData({ name: "Špik (near Bohinj)", lat: 46.3050, lon: 13.8750 }, 19, 'Julian Alps'),

    // --- Karavanke Alps (N) ---
    createHillData({ name: "Stol (Peak)", lat: 46.4422, lon: 14.1500 }, 20, 'Karavanke Alps'),
    createHillData({ name: "Košuta (Peak)", lat: 46.4517, lon: 14.5350 }, 21, 'Karavanke Alps'),
    ...
    createHillData({ name: "Golica (Karavanke)", lat: 46.4471, lon: 14.0729 }, 26, 'Karavanke Alps'),

    // --- Kamnik–Savinja Alps (N-C) ---
    createHillData({ name: "Grintovec (Peak)", lat: 46.3686, lon: 14.5317 }, 27, 'Kamnik–Savinja Alps'),
    ...
    createHillData({ name: "Krvavec (Ski Resort)", lat: 46.2890, lon: 14.4920 }, 34, 'Kamnik–Savinja Alps'),
    createHillData({ name: "Potočka zijalka", lat: 46.3980, lon: 14.6600 }, 35, 'Kamnik–Savinja Alps'),
    createHillData({ name: "Veliki vrh (near Gornji Grad)", lat: 46.3150, lon: 14.8100 }, 36, 'Kamnik–Savinja Alps'),
    ...
    createHillData({ name: "Črni Vrh (Pohorje)", lat: 46.5057, lon: 15.3411 }, 40, 'Pohorje'),
    ...
    createHillData({ name: "Boč (Dravinja Valley)", lat: 46.2801, lon: 15.5898 }, 43, 'Pohorje'),
    ...
    createHillData({ name: "Jezerski Vrh (near Maribor)", lat: 46.5592, lon: 15.6322 }, 46, 'Pohorje'),
    createHillData({ name: "Pohorski maršal (near Slovenj Gradec)", lat: 46.5000, lon: 15.1500 }, 47, 'Pohorje'),
    createHillData({ name: "Sveta Trojica (near Murska Sobota)", lat: 46.6690, lon: 16.1400 }, 48, 'Goričko'),
    ...
    createHillData({ name: "Blegoš (Peak)", lat: 46.1648, lon: 14.0042 }, 51, 'Škofja Loka Hills'),
    createHillData({ name: "Ratitovec (Peak)", lat: 46.2163, lon: 14.0706 }, 52, 'Škofja Loka Hills'),
    createHillData({ name: "Porezen", lat: 46.1645, lon: 13.9167 }, 53, 'Julian Pre-Alps'),
    createHillData({ name: "Matajur (near Kobarid)", lat: 46.2205, lon: 13.5658 }, 54, 'Julian Pre-Alps'),
    ...
    createHillData({ name: "Snežnik (Veliki Snežnik)", lat: 45.5818, lon: 14.4485 }, 57, 'Dinaric Alps'),
    createHillData({ name: "Nanos (Pleša)", lat: 45.7725, lon: 14.0083 }, 58, 'Dinaric Alps'),
    ...
    createHillData({ name: "Košanski vrh (Košana)", lat: 45.6980, lon: 14.0410 }, 62, 'Karst'),
    createHillData({ name: "Kokoš", lat: 45.6706, lon: 13.9026 }, 63, 'Karst'),
    createHillData({ name: "Lipovec (Kočevski Rog)", lat: 45.6558, lon: 14.9354 }, 64, 'Kočevski Rog'),
    ...
    createHillData({ name: "Hrib (near Koper)", lat: 45.4386, lon: 13.8684 }, 67, 'Karst Edge'),
    createHillData({ name: "Dvorina", lat: 45.4492, lon: 13.8403 }, 68, 'Karst Edge'),
    createHillData({ name: "Kucelj (near Postojna)", lat: 45.8200, lon: 14.1500 }, 69, 'Javorniki'),
    createHillData({ name: "Slavina", lat: 45.7800, lon: 14.0400 }, 70, 'Javorniki'),
    createHillData({ name: "Vrabče (near Nova Gorica)", lat: 45.9100, lon: 13.7100 }, 71, 'Vipava Hills'),
    createHillData({ name: "Cigoj (near Ajdovščina)", lat: 45.8950, lon: 13.9800 }, 72, 'Vipava Hills'),
    ...
    createHillData({ name: "Sv. Ana (Veliki Vrh)", lat: 46.2314, lon: 14.5778 }, 77, 'Savinja Hills'),
    createHillData({ name: "Slivnica (near Cerknica)", lat: 45.8078, lon: 14.3980 }, 78, 'Inner Carniola'),
    createHillData({ name: "Mala gora (near Ribnica)", lat: 45.7650, lon: 14.7350 }, 79, 'Ribnica-Kočevje Plateau'),
    createHillData({ name: "Polica (near Grosuplje)", lat: 45.9520, lon: 14.6540 }, 80, 'Grosuplje Hills'),
    createHillData({ name: "Golovec (Ljubljana)", lat: 46.0460, lon: 14.5320 }, 81, 'Ljubljana Basin Hills'),
    ...
    createHillData({ name: "Sv. Lovrenc (Polhov Gradec)", lat: 46.0825, lon: 14.2888 }, 84, 'Polhov Gradec Hills'),
    ...
    createHillData({ name: "Grmada (near Celje)", lat: 46.2420, lon: 15.2285 }, 89, 'Celje Hills'),
    ...
    createHillData({ name: "Mala gora (near Laško)", lat: 46.1300, lon: 15.2200 }, 94, 'Posavje Hills'),
    createHillData({ name: "Sv. Vid (near Stična)", lat: 45.9605, lon: 14.8680 }, 95, 'Dolenjska Hills'),
    createHillData({ name: "Trojane (Pass)", lat: 46.1550, lon: 14.8900 }, 96, 'Zasavje Hills'),

    // --- Dolenjska / Krka River Region & Posavje (SE) ---
    createHillData({ name: "Gorjanci (Trdinov vrh)", lat: 45.7485, lon: 15.3406 }, 97, 'Gorjanci'),
    createHillData({ name: "Tombolovica", lat: 45.7420, lon: 15.4199 }, 98, 'Gorjanci'),
    createHillData({ name: "Plešivica (near Novo Mesto)", lat: 45.8502, lon: 15.1235 }, 99, 'Dolenjska Hills'),
    createHillData({ name: "Sveti Peter (near Krško)", lat: 45.9820, lon: 15.4850 }, 100, 'Posavje Hills'),
    createHillData({ name: "Mali Lipovec (near Krka)", lat: 45.9220, lon: 15.0500 }, 101, 'Dolenjska Hills'),
    createHillData({ name: "Brezovica pri Trebelnem", lat: 45.9080, lon: 15.0650 }, 102, 'Dolenjska Hills'),
    createHillData({ name: "Vrh (near Semič)", lat: 45.6980, lon: 15.1850 }, 103, 'Bela Krajina'),
    ...
    createHillData({ name: "Straža (near Novo Mesto)", lat: 45.8640, lon: 14.8650 }, 106, 'Dolenjska Hills'),
    ...
    createHillData({ name: "Sv. Uršula (Zasavje)", lat: 46.2806, lon: 15.4140 }, 109, 'Zasavje Hills'),
    ...
    createHillData({ name: "Goli vrh (above Rimske Toplice)", lat: 46.1350, lon: 15.2280 }, 113, 'Posavje Hills'),
    createHillData({ name: "Sv. Andrej (near Velenje)", lat: 46.3900, lon: 15.0900 }, 114, 'Šalek Valley Hills'),
    createHillData({ name: "Pungert (near Velenje)", lat: 46.3500, lon: 15.0500 }, 115, 'Šalek Valley Hills'),
    createHillData({ name: "Mačkov hrib", lat: 45.9789, lon: 14.8752 }, 116, 'Dolenjska Hills'),
    createHillData({ name: "Strmica (near Cerklje)", lat: 46.2730, lon: 14.5020 }, 117, 'Kamnik Hills'),
    createHillData({ name: "Stolp (Vipava Valley)", lat: 45.8670, lon: 13.8470 }, 118, 'Vipava Hills'),
    createHillData({ name: "Mačkov hrib", lat: 45.9789, lon: 14.8752 }, 119, 'Dolenjska Hills'),
    createHillData({ name: "Stolp (Vipava Valley)", lat: 45.8670, lon: 13.8470 }, 120, 'Vipava Hills'),
];
